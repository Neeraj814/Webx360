    ...
    return (
        <div className='border rounded-md'>
            <Table>
                ...
                <TableBody>
                    {
                        applicants && applicants?.applications?.map((item: any) => (
                                        ...
                                        <PopoverContent className="w-32">
                                            {
                                                shortlistingStatus.map((status, index) => {
                                                    return (
                                                        <div onClick={() => statusHandler(status, item?._id)} key={index} className='flex w-full items-center my-2 cursor-pointer hover:bg-gray-100 p-2 rounded-md'>
                                                            <span>{status}</span>
                                                        </div>
                                                    )
                                                })
